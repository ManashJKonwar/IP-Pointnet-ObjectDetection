...
__reference__ = "https://github.com/charlesq34/frustum-pointnets/blob/master/train/provider.py"
__version__ = "1.0.1"
...
import pickle
import numpy as np
from utility.KITTI.viz_util import draw_lidar, draw_gt_boxes3d
from utility.KITTI.model_util import g_type2class, g_class2type, g_type2onehotclass, g_type_mean_size
from utility.KITTI.model_util import NUM_HEADING_BIN, NUM_SIZE_CLUSTER
...
class FrustumDataset(object):
    ...
    def __init__(self, npoints, split,
        ...
        if overwritten_data_path is None:
            overwritten_data_path = os.path.join(r'datasets\KITTI',
...
def visualize_frustum_data():
    ...
    train and validation splitted text files
    Parameters: 
